...
class MainApp(QMainWindow):
    ...
    def __init__(self):
        """ init things here """
        super().__init__()
        self.setWindowIcon(QtGui.QIcon('Icons\\Logo.png'))                       # parent class initializer
        # window title
        self.title = "RS WORD"
    ...
    def create_toolbar(self):
        ...
        # text alignment
        right_alignment_action = QAction(QIcon("Icons\\right-align.png"), 'Align Right', self)
        ...
        left_alignment_action = QAction(QIcon("Icons\\left-align.png"), 'Align Left', self)
        ...
        justification_action = QAction(QIcon("Icons\\justification.png"), 'Center/Justify', self)
        ...
        # zoom in
        zoom_in_action = QAction(QIcon("Icons\\zoom-in.png"), 'Zoom in', self)
        zoom_in_action.triggered.connect(self.editor.zoomIn)
        ToolBar.addAction(zoom_in_action)

        # zoom out
        zoom_out_action = QAction(QIcon("Icons\\zoom-out.png"), 'Zoom out', self)
